...
namespace Converter
{
    internal static class ILPreparer
    {
        ...
        public static void PrepareClass(string file, string @class, string outputFile)
        {
            ModuleContext modCtx = ModuleDef.CreateModuleContext();
            ModuleDef module = ModuleDefMD.Load(file, modCtx);
            dontUseThisClass = module.CorLibTypes.GetTypeRef("", "DontUseThisClass");

            var type = module.Types.SingleOrDefault(x => x.FullName == @class);
